...
def plot(filepaths,columnIndex,γ,ω,scalings):
    ...
    for i, filepath in enumerate(filepaths):
        ...
        if data is not None:
            ...
            normC12,normC21,crossCorrCoef = normalizedCrossCorrelation(integAmp2Signal*-1,y[::-1],time)
